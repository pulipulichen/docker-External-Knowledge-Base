...
const persistFields = ['query', 'categories', 'language', 'pageno', 'limit', 'safesearch', 'time_range'];
...
function buildPayloadFromForm() {
    ...
    const limit = normalizeOptionalInt(document.getElementById('limit').value, 5);
